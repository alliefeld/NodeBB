...
const viewsDir = nconf.get('views_dir') as string;
...
const Emailer = module.exports as Emailer;

const wellKnownServices:string = require('nodemailer/lib/well-known/services') as string;
